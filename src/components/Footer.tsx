  ...
  return (
    <footer className="border-t border-warm-200/50 bg-white px-6 py-16 md:px-10">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-wrap justify-between gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-warm-800/60">
              <Link to="/" className="transition-colors hover:text-brand-500">Home</Link>
              <Link to="/menu" className="transition-colors hover:text-brand-500">Menu</Link>
              <Link to="/contact" className="transition-colors hover:text-brand-500">Contact</Link>
            </div>
          </div>
          <div>
        ...
        <div className="mt-12 border-t border-warm-200/30 pt-6 text-center text-xs text-warm-800/30">&copy; {new Date().getFullYear()} Cookie Craze</div>
      </div>
    </footer>
  )
}
